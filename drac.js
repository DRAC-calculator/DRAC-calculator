...
jQuery(function() {
 ...
 jQuery('#drac_load_example_data').click(function(){
  var data = "";
	...
	data += 'DRAC-example Quartz Q Cresswelletal2018 3.4 0.51 14.47 1.69 1.2 0.14 0 0 N X X X X X X X X X X X X X X X X X N 90 125 Brennanetal1991 Guerinetal2012-Q 8 10 Bell1979 0 0 5 2 2.22 0.05 1.8 0.1 30 70 150 X X 20 0.2\n';
