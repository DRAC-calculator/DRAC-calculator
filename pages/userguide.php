...
<li>Copy and paste your data from the template into the data input box on the <a href="<?php echo DRAC_URL ?>?show=calculator">Calculator</a> page. You can calculate Ḋ for up to 100 samples at a time. You should also provide a name for the suite of calculations.</li>
<li>Press calculate.</li>
<li>A DRACoutput.csv file will be produced (see example version, which can be downloaded. This file will contain all of the inputted data and table outputs listed below.</li>
</ol>
</p>
...
<ul>
	<li><a href="<?php echo DRAC_URL ?>downloads/DRAC_Input_and_Output_Template_v2.xlsx">DRAC Input &amp; Output template</a></li>
	<li><a href="<?php echo DRAC_URL ?>downloads/Supplementary_Information_v8.xlsx">Supplementary Information</a></li>
